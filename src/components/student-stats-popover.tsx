      ...
      <AnimatePresence>
        {open && (
          ...
          >
            ...
            >
              <div className="space-y-2.5 sm:space-y-4 overflow-x-hidden max-w-full">
                <div>
                  <h3 className="text-sm sm:text-lg font-semibold mb-0.5 sm:mb-1">Help Request Statistics</h3>
