  ...
  return (
    <div className="flex items-center gap-2">
      <div className="relative">
        <div className={`${sizeClasses[size]} bg-gradient-primary rounded-2xl flex items-center justify-center shadow-soft`}>
      ...
      {showText && (
        <span className={`${textSizeClasses[size]} font-bold bg-gradient-primary bg-clip-text text-transparent`}>
          BUDDY
        </span>
      )}
    </div>
