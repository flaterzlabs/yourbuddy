...
export default function Welcome() {
      ...
      <div className="container mx-auto px-6 md:px-4 py-8">
        ...
        <div className="max-w-sm sm:max-w-2xl md:max-w-4xl mx-auto text-center">
          <div className="mb-8 md:mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-lg md:max-w-2xl mx-auto leading-relaxed px-4 md:px-0 font-extrabold md:text-6xl">Welcome to ThriveSprite</p>
          </div>

          {/* Student Focus Section */}
         <div className="mb-8 md:mb-12">
   <div className="max-w-xs sm:max-w-sm mx-auto">
     <RoleCard title="Student" description="I am a student who wants to communicate better and share how I feel" icon={User} selected={true} onClick={() => {}} />
   </div>
        </div>
  ...
  <div className="flex flex-col sm:flex-row sm:justify-center gap-3 sm:gap-4 w-full max-w-md">
    <Button variant="hero" size="lg" onClick={handleContinue} className="px-8 sm:px-12 w-full sm:w-auto transition-all duration-300 ease-in-out 
                 hover:scale-105 active:scale-95">
      Get Started
    </Button>

    <Button variant="outline" size="lg" onClick={() => navigate('/auth')} className="px-6 sm:px-8 w-full sm:w-auto transition-all duration-300 ease-in-out 
      ...
      I have an account
            ...
            <button onClick={() => navigate('/caregiver-auth')} className="text-primary hover:underline text-base font-medium mt-4">
